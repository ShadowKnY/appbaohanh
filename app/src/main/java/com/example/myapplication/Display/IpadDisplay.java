...
public class IpadDisplay extends AppCompatActivity {
    IpadDisplayBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = IpadDisplayBinding.inflate(getLayoutInflater());
    ...
    private void initRecyclerView() {
        ...
        items.add(new PopularDomain("iPad Pro M1","item_3",50,4.8,15,899,""));
        ...
        binding.ipadView.setLayoutManager(layoutManager);

        binding.ipadView.setAdapter(new PopularAdapter(items));
    }
}