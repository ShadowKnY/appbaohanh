...
import com.example.myapplication.databinding.WatchDisplayBinding;
import com.example.myapplication.domain.PopularDomain;

import java.util.ArrayList;
import java.util.List;

public class WatchDisplay extends AppCompatActivity {
    WatchDisplayBinding binding;
...
//        recyclerView.setAdapter(adapter);
        binding = WatchDisplayBinding.inflate(getLayoutInflater());
    ...
    private void initRecyclerView() {
        ...
        items.add(new PopularDomain("Apple What The Fuck","item_3",50,4.8,15,899,""));
        ...
        binding.watchView.setLayoutManager(layoutManager);
        binding.watchView.setAdapter(new PopularAdapter(items));
    }
}